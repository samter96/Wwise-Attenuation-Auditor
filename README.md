...
![version](https://img.shields.io/badge/version-V.2.0.3-blue) ![desktop](https://img.shields.io/badge/desktop-Tauri%202-purple) ![wwise](https://img.shields.io/badge/Wwise-WAAPI-orange)
...
1. `releases\Attenuation Auditor_2.0.3_x64-setup.exe` 실행
